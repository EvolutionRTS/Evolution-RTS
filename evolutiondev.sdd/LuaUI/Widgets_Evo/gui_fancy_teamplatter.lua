...
local skipOwnAllyTeam                   = false    -- keep this 'true' if you dont want circles rendered under your own units
...
local keepTeamColorsForSmallAllyTeam    = 16       -- (number of teams)   use teamcolors if number or teams (inside allyTeam)  <=  this value
