...
local SMALL_UNIT		= UnitDefNames["elighttank3"].id
local MEDIUM_UNIT		= UnitDefNames["emediumtank3"].id
local LARGE_UNIT		= UnitDefNames["eheavytank3"].id
local REFERENCE_UNIT	= UnitDefNames["efatso2"].id
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
--
-- Teams
...
local VERYEASY	= "Survival Spawner: Very Easy"
local EASY		= "Survival Spawner: Easy"
local NORMAL	= "Survival Spawner: Normal"
local HARD		= "Survival Spawner: Hard"
local VERYHARD	= "Survival Spawner: Very Hard"
...
local placerMode	=	(gameMode == "feature" or gameMode == "sandbox")
...
if ( AIfaction == "outer_colonies") then
	VFS.Include("LuaRules/Configs/faction1_spawndefs.lua")
	Spring.Echo("I have loaded the definitions for survival mode correctly!")
	-- else
	-- VFS.Include("LuaRules/Configs/faction1_spawndefs.lua")
	-- Spring.Echo("AI Faction not detected, loading default definitions.")
end
