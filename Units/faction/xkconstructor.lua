-- UNITDEF -- xkconstructor --
--------------------------------------------------------------------------------

local unitName                   = "xkconstructor"
...
local unitDef                    = {
	...
	builder                      = true,
	buildTime                    = 5,
	buildpic					 = [[pattern/xkconstructor.png]],
	CanAttack			         = false,
	CanAssist			         = true,
	canBeAssisted                = true,
	CanCapture                   = false,
	...
	moveState			         = "2",
	name                         = "The Whatever",
	objectName                   = "faction/xkconstructor.s3o",
	script			             = "faction/xkconstructor.cob",
	radarDistance                = 0,
	repairable		             = false,
