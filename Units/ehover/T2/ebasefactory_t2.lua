...
local unitDef                     = {
	...
	corpse                        = "ammobox",
	description                   = [[Build Generators in order to unlock units in this factory and supply depots to free up supply in order to build those units.]],
	energyStorage                 = 0,
	energyUse                     = 0,
	energyMake                    = 0,
	explodeAs                     = "MEXPOP2",
