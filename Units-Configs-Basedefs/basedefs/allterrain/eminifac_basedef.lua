...
unitDef                      = {
	...
	--  unitRestricted	           = 1,
	workerTime                     = 1,
	yardMap                        = "oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo oooyyyyyyyyyyyyyyyyooo",
